...
class PoseHighResolutionNet(nn.Module):
    def __init__(self, cfg, heads):
        ...
        self.last_layer = nn.Sequential(
            nn.Conv2d(
                in_channels=last_inp_channels, out_channels=64, kernel_size=1, stride=1, padding=0
            ),
    ...
    def forward(self, x):
        ...
        # print("z dictionary posehrnet ouput", z)
        return [z]
...
def freeze_module(module):
    """
        Make this module not trainable.
        This method sets all parameters to `requires_grad=False`,
        and sets all BatchNorm layers to eval mode
        """
...
# sanity check that freeze works
def print_layers_with_gradients(model):
